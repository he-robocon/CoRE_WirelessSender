...
typedef SPi< P36, P37, P35, P1 > spi; // USB Module v1.2 SPI pins
...
void MAX3421e< SPI_SS, INTR >::regWr(uint8_t reg, uint8_t data) {
        ...
        USB_SPI.beginTransaction(SPISettings(8000000, MSBFIRST, SPI_MODE0)); // Stable clock for the M5Stack USB Module v1.2
#endif
        SPI_SS::Clear();
